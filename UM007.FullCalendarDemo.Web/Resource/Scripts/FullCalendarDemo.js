$(document).ready(function () {
    $("#start").timepicker({
        dateFormat: 'yy-mm-dd', timeFormat: 'hh:mm', hourMin: 5, hourMax: 24, hourGrid: 3, minuteGrid: 15, timeText: '时间', hourText: '时', minuteText: '分', timeOnlyTitle: '选择时间', onClose: function (dateText, inst) {
            if ($('#start').val() != '') {
    ...
    $("#end").datetimepicker({
        dateFormat: 'yy-mm-dd', hourMin: 5, hourMax: 23, hourGrid: 3, minuteGrid: 15, timeText: '时间', hourText: '时', minuteText: '分', onClose: function (dateText, inst) {
            if ($('#start').val() != '') {
                var testStartDate = $('#start').datetimepicker('getDate');
                var testEndDate = $("#end").datetimepicker('getDate');
                if (testStartDate > testEndDate)
    ...
    $('#calendar').fullCalendar({
        ...
        viewDisplay: function (view) {//动态把数据查出，按照月份动态查询
            ...
            $.post("../ASHX/AccessDate.ashx", { start: viewStart, end: viewEnd }, function (data) {
                ...
                buttons: {
                    ...
                    "确认": function () {
                        ...
                        $.ajax({
                            ...
                            url: "../ASHX/getallid.ashx", //要访问的后台地址
                            data: schdata, //要发送的数据
                ...
                buttons: {
                    "删除": function () {
                        ...
                        if (aa) {
                            ...
                            $.ajax({
                                ...
                                url: "../ASHX/removedate.ashx", //要访问的后台地址
                                data: para, //要发送的数据
                                success: function (data) {
                                    //对话框里面的数据提交完成，data为操作结果
                    ...
                    "提交修改": function () {
                        ...
                        $.ajax({
                            ...
                            url: "../ASHX/Updateinfo.ashx", //要访问的后台地址
                            data: schdata, //要发送的数据
                            success: function (data) {
                                //对话框里面的数据提交完成，data为操作结果
